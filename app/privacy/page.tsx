...
import { PrivacyTocBar } from "@/components/privacy/PrivacyTocBar";
import {
  privacyMeta,
  privacySummary,
  privacySections,
...
export const metadata: Metadata = {
  ...
  description:
    "Как мы обрабатываем персональные данные пользователей сервиса SDViGApp в соответствии с 152-ФЗ.",
};

const summaryIcons = [Eye, Shield, UserCheck];
      ...
      <section className="bg-bg-primary pt-20 md:pt-28 pb-12">
        <Container>
          <div className="max-w-[820px]">
            ...
            <h1 className="text-h1 text-text-primary">{privacyMeta.title}</h1>
      ...
      <section className="bg-bg-primary py-12">
        <Container>
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6 max-w-[1100px]">
            {privacySummary.map((s, i) => {
              const Icon = summaryIcons[i] || Shield;
              return (
                <div
                  key={s.title}
        ...
        <Container>
          <div className="grid grid-cols-1 lg:grid-cols-12 gap-10 lg:gap-16">
            <aside className="lg:col-span-3">
              <div
                id="privacy-inline-toc"
                className="lg:sticky lg:top-24"
              >
                <h4 className="text-caption text-text-muted mb-4">
                  Содержание
                </h4>
                <nav>
